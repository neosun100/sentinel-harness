...
| **Evidence / reproducibility** | 21 runnable scenarios each write an account-scrubbed JSON to `evidence/` (36 artifacts); 2352 offline, deterministic tests (zero AWS by default) | Your tests | Your tests | Your tests |
...
Numbers above (2352 tests, 21 scenarios, 36 evidence artifacts, 20 tools, 9 skills,
