...
| **Evidence / reproducibility** | 16 runnable scenarios each write an account-scrubbed JSON to `evidence/` (23 artifacts); 1475 offline, deterministic tests (zero AWS by default) | Your tests | Your tests | Your tests |
...
Numbers above (1475 tests, 16 scenarios, 23 evidence artifacts, 14 tools, 9 skills,
