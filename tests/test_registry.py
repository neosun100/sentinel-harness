...
def test_load_registry_with_shipped_yaml_dual_gate():
    ...
    factory_map = {n: _factory(n) for n in
                   ("sigma_yara_lint", "detection_translate", "nvd_lookup", "epss_kev", "attack_lookup",
    ...
    assert reg.list_live() == ["asset_lookup", "attack_lookup", "create_ticket", "detection_translate", "enrich_ioc",
