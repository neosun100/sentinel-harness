...
def test_load_registry_with_shipped_yaml_dual_gate():
    ...
    factory_map = {n: _factory(n) for n in
                   ("sigma_yara_lint", "detection_translate", "detection_dedup",
                    "detection_coverage", "detection_audit", "nvd_lookup", "epss_kev",
                    "attack_lookup", "harness_ops", "run_evaluation", "sigma_match",
                    "asset_lookup", "siem_query", "enrich_ioc", "create_ticket",
    ...
    assert reg.list_live() == ["asset_lookup", "attack_lookup", "create_ticket",
                               ...
                               "detection_translate", "enrich_ioc", "epss_kev", "harness_ops",
                               "nvd_lookup", "ops_query", "run_evaluation", "siem_query",
                               "sigma_match", "sigma_yara_lint", "whitelist_optimizer"]
...
def test_shipped_yaml_flags_missing_impl_as_drift():
    ...
    assert set(rep.approved_missing_impl) == {
        "sigma_yara_lint", "detection_translate", "detection_dedup",
        "detection_coverage", "detection_audit", "nvd_lookup", "epss_kev",
        "attack_lookup", "harness_ops", "run_evaluation", "sigma_match", "asset_lookup",
